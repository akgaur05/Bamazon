module.exports = function displayTableValues(array, numRowsPerGroup, columnType) {
    //We can apply precision to numbers
    array.forEach(row => {
        for (let key in row) {
    ...
    //finding longest word and set width according to that (took help from other developer's code)
    const columnWidths = {};
